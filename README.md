...
These files provide the simulation result records used for the obstacle-free and obstacle execution-feasibility analysis. The complete UE4/AirSim project files are not included because the algorithmic reproducibility of SACWDO-PSO is supported by the released source code, benchmark dataset, parameter settings, and fixed random seed.
